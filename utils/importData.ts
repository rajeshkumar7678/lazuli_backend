...
async function importDataToCollections() {
  // Prepare categories data
  const categories = productData.map(({ category, collections }: any) => ({
    name: category,
    slug: category,
  ...
  // Prepare products data (flattened)
  const products = productData.flatMap(({ category, collections }: any) =>
  ...
  try {
    // Assuming you have your database connection and models set up
...
export default importDataToCollections;
